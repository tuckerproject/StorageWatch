...
public class TestDatabaseFactory : IAsyncDisposable
{
    ...
    public static async Task<TestDatabaseFactory> CreateAsync()
    {
        ...
        var ingestionService = new RawRowIngestionService(options);

        return new TestDatabaseFactory(connection, options, schema, ingestionService, databaseId);
    }
    ...
    public RawRowIngestionService GetIngestionService()
    {
