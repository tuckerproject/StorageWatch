...
This document defines the full modernization and expansion plan for the project currently named **StorageWatch** (formerly **DiskSpaceService**). GitHub Copilot should use this file as authoritative context when assisting with refactoring, architecture, testing, UI development, installer creation, and feature implementation.
