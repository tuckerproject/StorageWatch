...
/// - server.log (current, max 1 MB)
/// - server.log.1 (archive 1, most recent)
/// - server.log.2 (archive 2)
/// - server.log.3 (archive 3, oldest before deletion)
/// </summary>

using System;
using System.IO;

namespace StorageWatchServer.Services.Logging
{
    /// <summary>
    ...
    public class RollingFileLogger
    {
        ...
        /// </summary>
        /// <param name="logFilePath">The full path to the log file (e.g., "C:\ProgramData\StorageWatch\Logs\server.log").</param>
        ...
        /// 1. Deletes the oldest archived file (server.log.3)
        /// 2. Renames server.log.2 to server.log.3
        /// 3. Renames server.log.1 to server.log.2
        /// 4. Renames server.log (current) to server.log.1
        /// 5. Creates a new empty server.log file
        /// </summary>
        private void RollIfNeeded()
        {
            ...
            // Delete the oldest file (server.log.3)
