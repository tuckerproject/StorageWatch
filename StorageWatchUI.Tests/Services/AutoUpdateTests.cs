...
namespace StorageWatchUI.Tests.Services
{
    public class AutoUpdateTests
    {
        ...
        [Fact]
        public async Task UiUpdateInstaller_ReturnsFailure_WhenStagingDirectoryMissing()
        {
            var tempTarget = TestDirectoryFactory.CreateTempDirectory();
        ...
        [Fact]
        public async Task UiUpdateInstaller_ReturnsFailure_WhenManifestFileDoesNotExist()
        {
            var tempTarget = TestDirectoryFactory.CreateTempDirectory();
        ...
        [Fact]
        public async Task UiUpdateDownloader_ReturnsFailure_OnNetworkTimeout()
        {
            var component = new ComponentUpdateInfo
            {
                Version = "1.0.1",
            ...
            var httpClient = new HttpClient(handler);
            var downloader = new UiUpdateDownloader(httpClient, new TestLogger<UiUpdateDownloader>());
