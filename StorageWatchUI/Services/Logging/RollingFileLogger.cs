...
/// - ui.log (current, max 1 MB)
/// - ui.log.1 (archive 1, most recent)
/// - ui.log.2 (archive 2)
/// - ui.log.3 (archive 3, oldest before deletion)
/// </summary>

using System;
using System.IO;

namespace StorageWatchUI.Services.Logging
{
    /// <summary>
    ...
    public class RollingFileLogger
    {
        ...
        /// </summary>
        /// <param name="logFilePath">The full path to the log file (e.g., "C:\ProgramData\StorageWatch\Logs\ui.log").</param>
        ...
        /// 1. Deletes the oldest archived file (ui.log.3)
        /// 2. Renames ui.log.2 to ui.log.3
        /// 3. Renames ui.log.1 to ui.log.2
        /// 4. Renames ui.log (current) to ui.log.1
        /// 5. Creates a new empty ui.log file
        /// </summary>
        private void RollIfNeeded()
        {
            ...
            // Delete the oldest file (ui.log.3)
