/// <summary>
/// Configuration Loader for DiskSpaceService
/// 
/// This utility class is responsible for loading and parsing the XML configuration file (DiskSpaceConfig.xml)
...
namespace DiskSpaceService.Config
{
    ...
    {
        /// <summary>
        /// Loads the XML configuration file and returns a fully-populated DiskSpaceConfig object.
        /// </summary>
        /// <param name="path">The file path to the DiskSpaceConfig.xml file.</param>
        /// <returns>A populated DiskSpaceConfig object with all configuration settings.</returns>
        ...
        public static DiskSpaceConfig Load(string path)
        {
            ...
            // Populate the DiskSpaceConfig object by reading each XML element.
